 ...
 *
 * Bank two provider service
 */
class Bank2Service extends DefaultProfiderService implements ProviderInterface
{
    /**
     * @var
     */
    ...
    {
        return parent::getGenericEventId($this->request->get('action'));
    }
